...
class RNN_CNN_model(object):
	...
	def build_model(self):
		...
		conv_output = tf.contrib.layers.conv2d(inputs = output, num_outputs = self.output_channel, kernel_size = [3,output.shape[2]], padding='VALID')
